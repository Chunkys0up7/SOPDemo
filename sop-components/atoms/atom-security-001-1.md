...
This component provides a standardized form step that ensures consistency and compliance across all security operations.

## Description

The Form Step component is a reusable atomic element designed to be included in larger procedures. It provides a single-purpose, focused set of instructions for performing form activities.
...
**Excluded:**
- Advanced form scenarios (see advanced variation)
- Exception handling (handled at molecule level)

## Applicability

**Use this component when:**
- Performing routine form operations
...
**Change Log:**
- v1.0.0 (2025-07-03): Initial release - Security Team
