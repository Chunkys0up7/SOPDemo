---
id: molecule-benefits-enrollment
type: molecule
version: 1.0.0
title: Benefits Enrollment Procedure
tags: [hr, benefits, enrollment]
composedOf: [atom-benefits-overview]
dependencies:
  - atom-benefits-overview (v1.0.0+)
---
...
This procedure guides new employees through the benefits enrollment process during their first 30 days.

## Timeline

**Important**: Benefits enrollment must be completed within **30 days of hire date**. Missing this deadline may result in waiting until the next open enrollment period.
...
## Step 3: Access Enrollment Portal

1. Navigate to: **benefits.company.com**
2. Login credentials sent to personal email
3. If issues accessing, contact HR immediately
...
1. Review all selections carefully
2. Accept terms and conditions
3. Submit enrollment
4. **Print confirmation** for your records
5. Verify you receive email confirmation within 24 hours
...
- [ ] Any waivers (if declining coverage)

**Submit to**: hr-benefits@company.com
**Subject Line**: Benefits Enrollment - [Your Name]
...
- Decline company match (free money!)
...
- **General benefits**: hr-benefits@company.com
- **Portal issues**: it-support@company.com
- **Schedule consultation**: Book via calendar.company.com/benefits

## Timeline Recap

| Day | Action |
|-----|--------|
| Day 1-5 | Review benefits materials, assess needs |
| Day 6-20 | Complete online enrollment |
| Day 21-25 | Submit dependent documentation |
| Day 26-30 | Confirmation meeting with HR |

---
**Last Updated**: 2025-10-01
**Owner**: HR Department
**Estimated Time**: 1-2 hours for enrollment
