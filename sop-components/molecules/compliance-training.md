---
id: molecule-compliance-training
type: molecule
version: 1.1.0
title: Compliance Training Completion
tags: [compliance, training, legal]
composedOf: [atom-confidentiality-agreement]
dependencies:
  - atom-confidentiality-agreement (v1.0.0+)
---
...
All employees must complete mandatory compliance training within the first week of employment. This ensures everyone understands company policies, legal requirements, and ethical standards.
...
**Assessment**: 10 question quiz, 80% passing score

### Module 2: Confidentiality & Data Protection (45 minutes)
...
**Assessment**: 15 question quiz, 85% passing score
...
**Assessment**: 15 question quiz, 90% passing score

**Important**: Zero-tolerance policy for harassment
...
### Step 1: Access Training Platform

1. Navigate to: **training.company.com**
2. Login with your company credentials
3. If unable to access, contact IT immediately
...
- [ ] Safety procedures acknowledgment
...
- Sends confirmation email to you and your manager

## Timeline and Deadlines

| Training Component | Deadline | Duration |
|-------------------|----------|----------|
| All 5 modules | End of Week 1 | 3-4 hours total |
| Acknowledgments | End of Week 1 | 15 minutes |
...
**Note**: Department-specific training assigned automatically based on role
...
- **Direct manager**: (if comfortable)

**Protection**: Company prohibits retaliation against anyone who reports concerns in good faith
...
Your manager can also see your completion status and will follow up if you're behind schedule.
